...
echo "AC_DEFUN([SST_FOOPROJBAR_CONFIG_OUTPUT], [])" > config/sst_fooprojbar_config_output.m4
echo "dnl Automatically generated by SST configuration system" > config/sst_fooprojbar_include.m4
...
if test ! -d src/libltdl ; then
    echo "libltdl for fooprojbar exist.  Aborting."
    exit 1
fi
