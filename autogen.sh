...
echo "AC_DEFUN([SST_BKSIM_CONFIG_OUTPUT], [])" > config/sst_bksim_config_output.m4
echo "dnl Automatically generated by SST configuration system" > config/sst_bksim_include.m4
...
if test ! -d src/libltdl ; then
    echo "libltdl for bksim exist.  Aborting."
    exit 1
fi
